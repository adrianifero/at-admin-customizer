...
Customize Admin Dashboard helps you make the WordPress admin feel like *your* workspace.
...
2. Activate **Customize Admin Dashboard**.
3. Look for the color button in the bottom-right of any admin screen, or go to **Settings → Customize Admin**.

== Frequently Asked Questions ==

= Does this change my public site? =

No. Colors apply to the WordPress admin (and admin bar in the dashboard context). Your front-end theme is unchanged.
...
* Migrates previous 1.0.x widget options when present.
* Verified for WordPress 6.x / 7.x; Tested up to 7.1.

= 1.0.2a =
* Custom dashboard boxes and option to remove default metaboxes.
